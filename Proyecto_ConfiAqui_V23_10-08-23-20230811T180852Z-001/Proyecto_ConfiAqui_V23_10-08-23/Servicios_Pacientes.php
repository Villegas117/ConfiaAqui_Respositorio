...
<main class="container text-center">
        ...
        <!-- //*Tarjeta 1 -->
            ...
            <article class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card shadow text-bg-info mb-3">
                    <div class="card-body custom-card">
                        <a href="visualizar_citas.php" class="btn btn-outline-success">VER MIS CITAS</a>
                    </div>
                </div>
            </article>
            ...
            <article class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card shadow text-bg-info mb-3">
                    <div class="card-body custom-card">
                        <a href="borrar_citas.php" class="btn btn-outline-success">CANCELAR CITAS</a>
                    </div>
                </div>
            </article>
            <!-- //*Tarjeta 2 -->
            <article class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card shadow text-bg-info mb-3">
                    <div class="card-body custom-card">
                        <a href="actualizar_citas.php" class="btn btn-outline-success">REAGENDAR CITAS</a>
                    </div>
                </div>
            </article>
             <!-- //*Tarjeta 4 -->
